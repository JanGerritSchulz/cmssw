...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  namespace {
    ...
    void fillDescriptionsCommon(edm::ParameterSetDescription& desc) {
      ...
      */
      geometryParams
          .add<std::vector<double>>("caDCurvCuts", std::vector<double>(TrackerTraits::numberOfLayers, 99.))
          ->setComment("Cut on curvature difference between two consecutive triplets.");
      geometryParams
          .add<std::vector<double>>("caDCurv0", std::vector<double>(TrackerTraits::numberOfLayers, 99.))
