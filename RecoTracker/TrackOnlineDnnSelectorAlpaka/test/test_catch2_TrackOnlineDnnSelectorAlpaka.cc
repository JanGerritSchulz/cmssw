...
static constexpr auto s_tag = "[TrackOnlineDnnSelectorAlpaka]";

TEST_CASE("Standard checks of TrackOnlineDnnSelectorAlpaka", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("TrackOnlineDnnSelectorAlpaka"
