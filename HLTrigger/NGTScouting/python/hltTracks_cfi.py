...
hltPixelTrackTable = cms.EDProducer(
    ...
    variables = cms.PSet(
        ...
        duplicate = cms.PSet(src = cms.InputTag("pixelTrackAssoc","duplicate"),
                             ...
                             type = cms.string("uint8")),
        pileup = cms.PSet(src = cms.InputTag("pixelTrackAssoc","pileup"),
                             doc = cms.string("1 if mapped to pileup TP, 0 if signal and -1 if not mapped"),
                             type = cms.string("uint8")),
        ...
        tpCharge = cms.PSet(src = cms.InputTag("pixelTrackAssoc","tpCharge"),
                             ...
                             type = cms.string("int16")),
        tpVtxIdx  = cms.PSet(src = cms.InputTag("pixelTrackAssoc","tpVtxIdx"),
                             doc = cms.string("idx of matched TrackingParticle's production TrackingVertex"),
                             type = cms.string("int")),
        tpVtxDxy  = cms.PSet(src = cms.InputTag("pixelTrackAssoc","tpVtxDxy"),
                             doc = cms.string("dXY of matched TrackingParticle's production TrackingVertex"),
                             type = cms.string("float")),
        tpVtxX   = cms.PSet(src = cms.InputTag("pixelTrackAssoc","tpVtxX"),
                             doc = cms.string("vertex x of matched TrackingParticle"),
                             type = cms.string("float")),
        tpVtxY   = cms.PSet(src = cms.InputTag("pixelTrackAssoc","tpVtxY"),
                             doc = cms.string("vertex y of matched TrackingParticle"),
                             type = cms.string("float")),
        tpVtxZ   = cms.PSet(src = cms.InputTag("pixelTrackAssoc","tpVtxZ"),
                             doc = cms.string("vertex z of matched TrackingParticle"),
                             type = cms.string("float")),
        tpVtxPt2Sum  = cms.PSet(src = cms.InputTag("pixelTrackAssoc","tpVtxPt2Sum"),
                             doc = cms.string("pt2 sum of matched TrackingParticle's production TrackingVertex's daughters"),
                             type = cms.string("float")),
