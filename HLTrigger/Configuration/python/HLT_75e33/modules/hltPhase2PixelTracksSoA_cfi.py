...
layerPairs = [
    ...
    #  i,  o, start, phiCut,  minIn,  maxIn,  minOut,  maxOut, maxDR,  minDZ,  maxDZ, ptCuts, startR
    [  0,  1,  True,    350,  -17.0,   17.0,  -10000,   10000,   5.0,  -16.0,   16.0,  0.85,  99.0],
    [  0,  2,  True,    600,  -14.0,   14.0,  -10000,   10000,  10.0,  -16.0,   16.0,  0.85,  99.0],
    [  0,  4,  True,    450,    4.0,  10000,       0,    10.0,   8.0,    0.0,   25.0,  0.85,  99.0],
    [  0,  5,  True,    522,    7.0,  10000,       0,   10000,   5.0,    0.0,   25.0,  0.85,  99.0],
  # [  0,  6, False,    522,   11.0,  10000,       0,   10000,   5.0, -10000,  10000,  0.85,  99.0],
    [  0, 16,  True,    450, -10000,   -4.0,       0,    10.0,   8.0,  -25.0,    0.0,  0.85,  99.0],
    [  0, 17,  True,    522, -10000,   -7.0,       0,   10000,   5.0,  -25.0,    0.0,  0.85,  99.0],
  # [  0, 18, False,    522, -10000,  -10.0,       0,   10000,   5.0, -10000,  10000,  0.85,  99.0],
    [  1,  2,  True,    400,  -17.0,   17.0,  -10000,   10000,   7.0,  -13.0,   13.0,  0.85,  99.0],
    [  1,  3, False,    650,  -15.0,   15.0,  -10000,   10000,  10.0,  -15.0,   15.0,  0.85,  99.0],
    [  1,  4,  True,    500,    6.0,  10000,     6.5,   10000,   8.0,    0.0,   19.0,  0.85,  99.0],
    [  1,  5, False,    730,    9.0,  10000,     6.5,   10000,  10.0,    0.0,   21.0,  0.85,  99.0],
  # [  1,  6, False,    730,   13.0,  10000,     6.5,   10000,   8.0, -10000,  10000,  0.85,  99.0],
    [  1, 16,  True,    500, -10000,   -6.0,     6.5,   10000,   8.0,  -19.0,    0.0,  0.85,  99.0],
    [  1, 17, False,    730, -10000,   -9.0,     6.5,   10000,  10.0,  -21.0,    0.0,  0.85,  99.0],
  # [  1, 18, False,    730, -10000,  -13.0,     6.5,   10000,   8.0, -10000,  10000,  0.85,  99.0],
  # [  1, 28, False,   1300,    7.0,  10000,    30.0,    40.0, 10000,   19.0,   32.0,   1.0,  99.0],
  # [  1, 28, False,   1300, -10000,   -7.0,   -40.0,   -30.0, 10000,  -32.0,  -19.0,   1.0,  99.0],
    [  2,  3,  True,    350,  -18.0,   18.0,  -10000,   10000,   7.0,   -9.0,    9.0,  0.85,  99.0],
    [  2,  4, False,    400,   11.0,  10000,    11.7,   10000,   7.0,    0.0,   13.0,  0.85,  99.0],
    [  2, 16, False,    400, -10000,  -11.0,    11.7,   10000,   7.0,  -13.0,    0.0,  0.85,  99.0],
    [  2, 28, False,   1200,    -10,     10,   -30.0,    30.0, 10000,  -15.0,   15.0,   2.0,  99.0],
    [  2, 28, False,   1200,    -20,    -10,   -50.0,   -25.0, 10000,  -35.0,  -10.0,  0.85,  99.0],
    [  2, 28, False,   1200,     10,     20,    25.0,    50.0, 10000,   10.0,   35.0,  0.85,  99.0],
  # [  2, 28, False,   1200,    -20,     20,   -50.0,    50.0, 10000,  -35.0,   35.0,  0.85,  99.0],
    [  3, 28, False,   1000,    -20,     20,   -45.0,    45.0, 10000,  -22.0,   22.0,  0.85,  99.0],
  # [  3, 29, False,   1500,    -40,     40,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [  4,  5,  True,    300,      0,   14.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,  99.0],
    [  4,  6, False,    522,      0,   14.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,  99.0],
    [  4, 28, False,   1000,   11.6,  10000,    30.0,    57.5,  16.0,    5.0,   32.5,  0.85,  99.0],
  # [  4, 29, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [  5,  6,  True,    300,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,  99.0],
    [  5,  7, False,    522,      0,   13.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,  99.0],
    [  5, 28, False,   1000,   11.6,  10000,    40.0,    80.0,  16.0,  -10.0,   50.0,  0.85,  99.0],
  # [  5, 29, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [  6,  7,  True,    250,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,  99.0],
    [  6,  8, False,    522,      0,   13.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,  99.0],
    [  6, 28, False,   1000,   11.6,  10000,    55.0,    95.0,  16.0,    5.0,   50.0,  0.85,  99.0],
  # [  6, 29, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [  7,  8,  True,    250,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,  99.0],
    [  7,  9, False,    522,      0,   13.0,     3.5,   10000,   8.0, -10000,  10000,  0.85,  99.0],
    [  7, 28, False,   1000,   11.8,  10000,    70.0,   110.0,  16.0,   15.0,   70.0,  0.85,  99.0],
  # [  7, 29, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [  8,  9,  True,    250,      0,   13.0,     3.5,   10000,   4.0, -10000,  10000,  0.85,  99.0],
    [  8, 10, False,    522,      0,   13.0,     3.5,   10000,   8.0, -10000,  10000,  0.85,  99.0],
    [  8, 28, False,    850,      0,  10000,    80.0,   10000,  14.0,   25.0,   70.0,  0.85,  99.0],
  # [  8, 29, False,   1000,      0,  10000,       0,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [  9, 10,  True,    300,      0,   13.0,     4.0,   10000,   4.5, -10000,  10000,  0.85,  99.0],
    [  9, 11, False,    522,      0,   13.0,     4.0,   10000,   8.0, -10000,  10000,  0.85,  99.0],
  # [  9, 28, False,   1000,      0,  10000,       0,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [ 10, 11,  True,    240,      0,   13.0,     3.5,   10000,   4.0, -10000,  10000,  0.85,  99.0],
    [ 10, 12, False,    650,   12.5,   16.5,    20.0,   10000,  10.0, -10000,  10000,  0.85,  99.0],
    [ 11, 12, False,    300,      0,   16.5,     6.0,    21.0,   5.0, -10000,  10000,  0.85,  99.0],
    [ 11, 13, False,    200,      0,    6.0,       0,     7.5,   3.0, -10000,  10000,  0.85,  99.0],
    [ 11, 14, False,    220,      0,    4.6,       0,     7.5,   3.0, -10000,  10000,  0.85,  99.0],
    [ 11, 15, False,    250,      0,    6.0,       0,   10000,   4.0, -10000,  10000,  0.85,  99.0],
    [ 12, 13, False,    250,      0,   22.5,     7.0,   10000,   4.0, -10000,  10000,  0.85,  99.0],
    [ 13, 14, False,    250,      0,   22.5,     7.0,   10000,   4.0, -10000,  10000,  0.85,  99.0],
    [ 14, 15, False,    250,      0,   22.5,     7.0,   10000,   3.5, -10000,  10000,  0.85,  99.0],
    [ 16, 17,  True,    300,      0,   14.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,  99.0],
    [ 16, 18, False,    522,      0,   14.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,  99.0],
    [ 16, 28, False,   1000,   11.6,  10000,   -57.5,   -30.0,  16.0,  -32.5,   -5.0,  0.85,  99.0],
  # [ 16, 29, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [ 17, 18,  True,    300,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,  99.0],
    [ 17, 19, False,    522,      0,   13.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,  99.0],
    [ 17, 28, False,   1000,   11.6,  10000,   -70.0,   -40.0,  16.0,  -50.0,  -10.0,  0.85,  99.0],
  # [ 17, 29, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [ 18, 19,  True,    250,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,  99.0],
    [ 18, 20, False,    522,      0,   13.0,     3.5,   10000,   9.0, -10000,  10000,  0.85,  99.0],
    [ 18, 28, False,   1000,   11.6,  10000,   -95.0,   -55.0,  16.0,  -50.0,   -5.0,  0.85,  99.0],
  # [ 18, 29, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [ 19, 20,  True,    250,      0,   13.0,     3.5,   10000,   4.5, -10000,  10000,  0.85,  99.0],
    [ 19, 21, False,    522,      0,   13.0,     3.5,   10000,   8.0, -10000,  10000,  0.85,  99.0],
    [ 19, 28, False,   1000,   11.8,  10000,  -110.0,   -70.0,  16.0,  -70.0,  -15.0,  0.85,  99.0],
  # [ 19, 29, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [ 20, 21,  True,    250,      0,   13.0,     3.5,   10000,   4.0, -10000,  10000,  0.85,  99.0],
    [ 20, 22, False,    522,      0,   13.0,     3.5,   10000,   8.0, -10000,  10000,  0.85,  99.0],
    [ 20, 28, False,   1000,      0,  10000,  -10000,   -80.0,  14.0,  -70.0,  -25.0,  0.85,  99.0],
  # [ 20, 29, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [ 21, 22,  True,    300,      0,   13.0,     4.0,   10000,   4.5, -10000,  10000,  0.85,  99.0],
    [ 21, 23, False,    522,      0,   13.0,     4.0,   10000,   8.0, -10000,  10000,  0.85,  99.0],
  # [ 21, 28, False,   1000,      0,  10000,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [ 22, 23,  True,    240,      0,   13.0,     3.5,   10000,   4.0, -10000,  10000,  0.85,  99.0],
    [ 22, 24, False,    650,   12.5,   16.5,    20.0,   10000,  10.0, -10000,  10000,  0.85,  99.0],
    [ 23, 24, False,    300,      0,   16.5,     6.0,    21.0,   5.0, -10000,  10000,  0.85,  99.0],
    [ 23, 25, False,    200,      0,    6.0,       0,     7.5,   3.0, -10000,  10000,  0.85,  99.0],
    [ 23, 26, False,    220,      0,    4.6,       0,     7.5,   3.0, -10000,  10000,  0.85,  99.0],
    [ 23, 27, False,    250,      0,    6.0,       0,   10000,   4.0, -10000,  10000,  0.85,  99.0],
    [ 24, 25, False,    250,      0,   22.5,     7.0,   10000,   4.0, -10000,  10000,  0.85,  99.0],
    [ 25, 26, False,    250,      0,   22.5,     7.0,   10000,   4.0, -10000,  10000,  0.85,  99.0],
    [ 26, 27, False,    250,      0,   22.5,     7.0,   10000,   3.5, -10000,  10000,  0.85,  99.0],
    [ 28, 29, False,   1100,  -1200,   1200,  -10000,   10000, 10000,  -50.0,   50.0,  0.85,  99.0],
  # [ 28, 30, False,   2000,    -40,     40,  -10000,   10000, 10000, -10000,  10000,  0.85,  99.0],
    [ 29, 30, False,   1250,  -1200,   1200,  -10000,   10000, 10000,  -40.0,   40.0,  0.85,  99.0],
]
...
hltPhase2PixelTracksSoA = cms.EDProducer('CAHitNtupletAlpakaPhase2@alpaka',
    ...
    geometry = cms.PSet(
        ...
        startingPairMaxInnerR = cms.vdouble(startingPairMaxInnerRAlpaka),
...
_hltPhase2PixelTracksSoA = cms.EDProducer('CAHitNtupletAlpakaPhase2OT@alpaka',
    ...
    geometry = cms.PSet(
        ...
        startingPairMaxInnerR = cms.vdouble(startingPairMaxInnerRCAExtension),
