...
layers = [
    #     0,        1,     2,       3,      4,     5,     6
    # index, isBarrel, caDCA, caTheta, startR, DCurv, DCurv0
    [     0,     True,  0.15,   0.002,   99.0,  99.0,  99.0],
    [     1,     True,  0.25,   0.002,   99.0,  99.0,  99.0],
    [     2,     True,  0.20,   0.002,   99.0,  99.0,  99.0],
    [     3,     True,  0.20,   0.002,   99.0,  99.0,  99.0],
    [     4,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [     5,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [     6,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [     7,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [     8,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [     9,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    10,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    11,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    12,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    13,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    14,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    15,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    16,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    17,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    18,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    19,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    20,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    21,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    22,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    23,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    24,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    25,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    26,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    27,    False,  0.25,   0.003,   99.0,  99.0,  99.0],
    [    28,     True,  0.10,   0.003,   99.0,  99.0,  99.0],
    [    29,     True,  0.10,   0.003,   99.0,  99.0,  99.0],
    [    30,     True,  0.10,   0.003,   99.0,  99.0,  99.0],
]
...
_hltPhase2PixelTracksSoA = cms.EDProducer('CAHitNtupletAlpakaPhase2OT@alpaka',
    ...
    geometry = cms.PSet(
        ...
        caDCurvCuts    = cms.vdouble([l[5] for l in layers]),
        caDCurv0       = cms.vdouble([l[6] for l in layers]),
...
def _exclude_OT_layers(hltPhase2PixelTracksSoA, layers_to_exclude = [28, 29, 30]):
    ...
    hltPhase2PixelTracksSoA.geometry.caDCurvCuts[:] = [hltPhase2PixelTracksSoA.geometry.caDCurvCuts[i] for i in keep_indices]
