...
def _modifyForPhase2(trackvalidator):
    trackvalidator.label = ["hltGeneralTracks","hltPhase2PixelTracks","hltInitialStepTracks","hltInitialStepTrackSelectionHighPurity","hltHighPtTripletStepTracks","hltHighPtTripletStepTrackSelectionHighPurity"]
