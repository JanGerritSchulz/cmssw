...
#    "efficPtvseta 'Efficiency in p_{T}-#eta plane' num_assoc(simToReco)_pTvseta num_simul_pTvseta",
    ...
    "technicalEffic 'Technical efficiency vs #eta' num_assoc(reconstructableSimToReco)_eta num_reconstructableSim_eta",
    "technicalEfficPt 'Technical efficiency vs p_{T}' num_assoc(reconstructableSimToReco)_pT num_reconstructableSim_pT",
#   "technicalEfficPtvseta 'Technical efficiency in p_{T}-#eta plane' num_assoc(reconstructableSimToReco)_pTvseta num_reconstructableSim_pTvseta",
    "technicalEffic_vs_hit 'Technical efficiency vs hit' num_assoc(reconstructableSimToReco)_hit num_reconstructableSim_hit",
    "technicalEffic_vs_layer 'Technical efficiency vs layer' num_assoc(reconstructableSimToReco)_layer num_reconstructableSim_layer",
    "technicalEffic_vs_pixellayer 'Technical efficiency vs pixel layer' num_assoc(reconstructableSimToReco)_pixellayer num_reconstructableSim_pixellayer",
    "technicalEffic_vs_3Dlayer 'Technical efficiency vs 3D layer' num_assoc(reconstructableSimToReco)_3Dlayer num_reconstructableSim_3Dlayer",
    "technicalEffic_vs_pu 'Technical efficiency vs pu' num_assoc(reconstructableSimToReco)_pu num_reconstructableSim_pu",
    "technicalEffic_vs_phi 'Technical efficiency vs #phi' num_assoc(reconstructableSimToReco)_phi num_reconstructableSim_phi",
    "technicalEffic_vs_dxy 'Technical efficiency vs Dxy' num_assoc(reconstructableSimToReco)_dxy num_reconstructableSim_dxy",
    "technicalEffic_vs_dz 'Technical efficiency vs Dz' num_assoc(reconstructableSimToReco)_dz num_reconstructableSim_dz",
    "technicalEffic_vs_dxypv 'Technical efficiency vs Dxy(PV)' num_assoc(reconstructableSimToReco)_dxypv num_reconstructableSim_dxypv",
    "technicalEffic_vs_dzpv 'Technical efficiency vs Dz(PV)' num_assoc(reconstructableSimToReco)_dzpv num_reconstructableSim_dzpv",
    "technicalEffic_vs_dxypv_zoomed 'Technical efficiency vs Dxy(PV)' num_assoc(reconstructableSimToReco)_dxypv_zoomed num_reconstructableSim_dxypv_zoomed",
    "technicalEffic_vs_dzpv_zoomed 'Technical efficiency vs Dz(PV)' num_assoc(reconstructableSimToReco)_dzpv_zoomed num_reconstructableSim_dzpv_zoomed",
...
#    "chargeMisIdRate_Ptvseta 'Charge MisID Rate in (p_{T}-#eta) plane' num_chargemisid_pTvseta num_reco_pTvseta",
    ...
    "technicalEffic_vs_vertpos 'Technical efficiency vs vertpos' num_assoc(reconstructableSimToReco)_vertpos num_reconstructableSim_vertpos",
    "technicalEffic_vs_zpos 'Technical efficiency vs zpos' num_assoc(reconstructableSimToReco)_zpos num_reconstructableSim_zpos",
    "technicalEffic_vs_dr 'Technical efficiency vs dr' num_assoc(reconstructableSimToReco)_dr num_reconstructableSim_dr",
    "technicalEffic_vs_drj 'Technical efficiency vs dr (track,jet)' num_assoc(reconstructableSimToReco)_drj num_reconstructableSim_drj",
