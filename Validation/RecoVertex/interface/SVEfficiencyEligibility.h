...
//
//   Stage 2 (finalizeEligibility): folds in the PDG ID cut once motherPdgId
//            is known (or defaulted to 0 if Stage 1 decided it wasn't worth
//            computing), producing the final per-bundle bitmask.
//
