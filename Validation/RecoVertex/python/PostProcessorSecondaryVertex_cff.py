...
postProcessorSecondaryVertex = DQMEDHarvester("DQMGenericClient",
    ...
    resolution = cms.vstring(
        ...
        "massres_vs_decayLength 'Mass resolution vs L_{3D};L_{3D} [cm];#sigma(m) [GeV]' mass_res_vs_decayLength",
        "massres_vs_decayLengthXY 'Mass resolution vs L_{2D};L_{2D} [cm];#sigma(m) [GeV]' mass_res_vs_decayLengthXY",
        "massres_vs_nTracks 'Mass resolution vs N tracks;Number of tracks in RecoSV;#sigma(m)' mass_res_vs_nTracks",
    ),
