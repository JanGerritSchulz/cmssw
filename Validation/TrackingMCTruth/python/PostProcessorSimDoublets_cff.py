...
postProcessorSimNtuplets = DQMEDHarvester("DQMGenericClient",
    ...
    efficiency = cms.vstring(
        ...
        "SimNtuplets/longest/fracKilledDoubletConnections_vs_pt 'Fraction of TPs with longest SimNtuplet with killed doublet connections vs p_{T}; TP transverse momentum p_{T} [GeV]; Fraction' SimNtuplets/longest/num_pt_killedDoubletConnections general/num_vs_pt",
        "SimNtuplets/longest/fracKilledDoubletConnections_vs_eta 'Fraction of TPs with longest SimNtuplet with killed doublet connections vs #eta; TP pseudorapidity #eta; Fraction' SimNtuplets/longest/num_eta_killedDoubletConnections general/num_vs_eta",
        "SimNtuplets/longest/fracKilledTripletConnections_vs_pt 'Fraction of TPs with longest SimNtuplet with killed triplet connections vs p_{T}; TP transverse momentum p_{T} [GeV]; Fraction' SimNtuplets/longest/num_pt_killedTripletConnections general/num_vs_pt",
        "SimNtuplets/longest/fracKilledTripletConnections_vs_eta 'Fraction of TPs with longest SimNtuplet with killed triplet connections vs #eta; TP pseudorapidity #eta; Fraction' SimNtuplets/longest/num_eta_killedTripletConnections general/num_vs_eta",
        ...
        "SimNtuplets/mostAlive/fracKilledDoubletConnections_vs_pt 'Fraction of TPs with most alive SimNtuplet with killed doublet connections vs p_{T}; TP transverse momentum p_{T} [GeV]; Fraction' SimNtuplets/mostAlive/num_pt_killedDoubletConnections general/num_vs_pt",
        "SimNtuplets/mostAlive/fracKilledDoubletConnections_vs_eta 'Fraction of TPs with most alive SimNtuplet with killed doublet connections vs #eta; TP pseudorapidity #eta; Fraction' SimNtuplets/mostAlive/num_eta_killedDoubletConnections general/num_vs_eta",
        "SimNtuplets/mostAlive/fracKilledTripletConnections_vs_pt 'Fraction of TPs with most alive SimNtuplet with killed triplet connections vs p_{T}; TP transverse momentum p_{T} [GeV]; Fraction' SimNtuplets/mostAlive/num_pt_killedTripletConnections general/num_vs_pt",
        "SimNtuplets/mostAlive/fracKilledTripletConnections_vs_eta 'Fraction of TPs with most alive SimNtuplet with killed triplet connections vs #eta; TP pseudorapidity #eta; Fraction' SimNtuplets/mostAlive/num_eta_killedTripletConnections general/num_vs_eta",
