...
namespace phase2PixelTopology {
  ...
  constexpr uint32_t numberOfLayers = 28;
  constexpr int nPairs = 23 + 6 + 14 + 8 + 4 + (4+4) -12 -2 -8 -10;  // include far forward layer pairs
  ...
  HOST_DEVICE_CONSTANT uint8_t layerPairs[2 * nPairs] = {
      ...
      // 4,  6,  5,  7,  6,  8,  7,  9,  8,  10, 9,  11,  // POS Jump (48)
      // 10, 12,
      // 16, 18, 17, 19, 18, 20, 19, 21, 20, 22, 21, 23,  // NEG Jump (55)
      // 22, 24,

      // additional pairs
      // 9,  12, 
      // 11, 13, 11, 14, 11, 15,  // very POS Jump (59)
      // 21, 24, 
      // 23, 25, 23, 26, 23, 27,  // very NEG Jump (63)
  };
  ...
  HOST_DEVICE_CONSTANT float minz[nPairs] = {
      ...
      // 23.0, 30.0,  39.0,  50.0,  65.0,  82.0,  
      // 109.0, 
      // -28.0, -35.0, -44.0,  -55.0,  -70.0,  -87.0,  
      // -113.0,
      // 70.0, 
      // 120.0, 120.0, 120.0, 
      //  -100.0, 
