...
namespace phase2PixelTopology {
  ...
  constexpr uint32_t numberOfLayers = 28;
  constexpr int nPairs = 23 + 6 + 14 + 8 + 4 + (4+4);  // include far forward layer pairs
  ...
  HOST_DEVICE_CONSTANT uint8_t layerPairs[2 * nPairs] = {
      ...
      // additional pairs
      9,  12, 11, 13, 11, 14, 11, 15,  // very POS Jump (59)
      21, 24, 23, 25, 23, 26, 23, 27,  // very NEG Jump (63)
  };
  ...
  HOST_DEVICE_CONSTANT int16_t phicuts[nPairs]{
      ...
      phi0p09, phi0p05, phi0p05, phi0p05,
      phi0p09, phi0p05, phi0p05, phi0p05};
